...
def cart(request, total=0, quantity=0, cart_items=None):
    ...
    for cart_item in cart_items:
        if cart_item.product.old_price is not None and cart_item.quantity > 0:
            cart_item.old_total = cart_item.product.old_price * cart_item.quantity
        else:
            cart_item.old_total = 0
